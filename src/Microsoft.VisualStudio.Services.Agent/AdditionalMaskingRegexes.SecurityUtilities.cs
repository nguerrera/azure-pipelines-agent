...
namespace Microsoft.VisualStudio.Services.Agent
{
    ...
    {
        public static IEnumerable<string> SecurityUtilitiesPatterns => _securityUtilitiesPatterns;

        // These patterns are a subset of those provided by Microsoft.Security.Utilities.Core.
        // They can be used with the legacy secret masker.
        private static IEnumerable<string> _securityUtilitiesPatterns =
            new List<string>()
            {
